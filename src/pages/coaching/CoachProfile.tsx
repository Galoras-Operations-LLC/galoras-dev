import { useEffect, useMemo, useState } from "react";
    ...
    const fetchCoach = async () => {
      ...
      try {
        let query = supabase
          .from("coaches")
          .select(
            "id, slug, display_name, headline, positioning_statement, methodology, proof_points, audience,
  ...
  md:justify-between">
        ...
        {paymentError && !checkoutOpen && (
          <div className="fixed bottom-4 right-4 max-w-sm rounded-lg bg-destructive/10 border
